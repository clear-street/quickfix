...
func NewNoNestedInstrAttribRepeatingGroup() NoNestedInstrAttribRepeatingGroup {
	return NoNestedInstrAttribRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.NestedInstrAttribType),
				quickfix.GroupElement(tag.NestedInstrAttribValue),
			},
		),
	}
}
...
func NewNoMaturityRulesRepeatingGroup() NoMaturityRulesRepeatingGroup {
	return NoMaturityRulesRepeatingGroup{
		quickfix.NewRepeatingGroup(
			tag.NoMaturityRules,
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.MaturityRuleID),
				quickfix.GroupElement(tag.MaturityMonthYearFormat),
				quickfix.GroupElement(tag.MaturityMonthYearIncrementUnits),
				quickfix.GroupElement(tag.StartMaturityMonthYear),
				quickfix.GroupElement(tag.EndMaturityMonthYear),
				quickfix.GroupElement(tag.MaturityMonthYearIncrement),
			},
		),
	}
}
...
func NewNoStrikeRulesRepeatingGroup() NoStrikeRulesRepeatingGroup {
	return NoStrikeRulesRepeatingGroup{
		quickfix.NewRepeatingGroup(
			tag.NoStrikeRules,
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.StrikeRuleID),
				quickfix.GroupElement(tag.StartStrikePxRange),
				quickfix.GroupElement(tag.EndStrikePxRange),
				quickfix.GroupElement(tag.StrikeIncrement),
				quickfix.GroupElement(tag.StrikeExerciseStyle),
				NewNoMaturityRulesRepeatingGroup(),
			},
		),
	}
}
	...
	return NoRelatedSymRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				...
				NewNoTickRulesRepeatingGroup(),
				NewNoLotTypeRulesRepeatingGroup(),
				quickfix.GroupElement(tag.PriceLimitType),
				quickfix.GroupElement(tag.LowLimitPrice),
				quickfix.GroupElement(tag.HighLimitPrice),
				quickfix.GroupElement(tag.TradingReferencePrice),
				quickfix.GroupElement(tag.ExpirationCycle),
				quickfix.GroupElement(tag.MinTradeVol),
				quickfix.GroupElement(tag.MaxTradeVol),
				quickfix.GroupElement(tag.MaxPriceVariation),
				quickfix.GroupElement(tag.ImpliedMarketIndicator),
				quickfix.GroupElement(tag.TradingCurrency),
				quickfix.GroupElement(tag.RoundLot),
				quickfix.GroupElement(tag.MultilegModel),
				quickfix.GroupElement(tag.MultilegPriceMethod),
				quickfix.GroupElement(tag.PriceType),
				NewNoTradingSessionRulesRepeatingGroup(),
				NewNoNestedInstrAttribRepeatingGroup(),
				NewNoStrikeRulesRepeatingGroup(),
				quickfix.GroupElement(tag.RelSymTransactTime),
			},
		),
	}
}
