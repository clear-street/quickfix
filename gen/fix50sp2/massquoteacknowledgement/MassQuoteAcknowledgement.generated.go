	...
	return NoQuoteEntriesRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				...
				quickfix.GroupElement(tag.QuoteEntryStatus),
	...
	return NoQuoteSetsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				...
				quickfix.GroupElement(tag.TotNoCxldQuotes),
				quickfix.GroupElement(tag.TotNoAccQuotes),
				quickfix.GroupElement(tag.TotNoRejQuotes),
