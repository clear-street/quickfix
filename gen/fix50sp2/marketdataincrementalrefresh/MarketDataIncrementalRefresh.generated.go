...
func NewNoOfSecSizesRepeatingGroup() NoOfSecSizesRepeatingGroup {
	return NoOfSecSizesRepeatingGroup{
		quickfix.NewRepeatingGroup(
			tag.NoOfSecSizes,
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.MDSecSizeType),
				quickfix.GroupElement(tag.MDSecSize),
			},
		),
	}
}
...
func NewNoStatsIndicatorsRepeatingGroup() NoStatsIndicatorsRepeatingGroup {
	return NoStatsIndicatorsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.StatsType),
			},
		),
	}
}
	...
	return NoMDEntriesRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				...
				quickfix.GroupElement(tag.MDOriginType),
				quickfix.GroupElement(tag.HighPx),
				quickfix.GroupElement(tag.LowPx),
				quickfix.GroupElement(tag.TradeVolume),
				quickfix.GroupElement(tag.SettlType),
				quickfix.GroupElement(tag.SettlDate),
				quickfix.GroupElement(tag.MDQuoteType),
				quickfix.GroupElement(tag.RptSeq),
				quickfix.GroupElement(tag.DealingCapacity),
				quickfix.GroupElement(tag.MDEntrySpotRate),
				quickfix.GroupElement(tag.MDEntryForwardPoints),
				quickfix.GroupElement(tag.MDPriceLevel),
				...
				NewNoOfSecSizesRepeatingGroup(),
				quickfix.GroupElement(tag.LotType),
				quickfix.GroupElement(tag.SecurityTradingStatus),
				quickfix.GroupElement(tag.HaltReasonInt),
				...
				NewNoStatsIndicatorsRepeatingGroup(),
				quickfix.GroupElement(tag.SettlCurrency),
				NewNoRateSourcesRepeatingGroup(),
				quickfix.GroupElement(tag.FirstPx),
				quickfix.GroupElement(tag.LastPx),
				quickfix.GroupElement(tag.MDStreamID),
			},
		),
	}
}
