	...
	return NoRelatedSymRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				...
				quickfix.GroupElement(tag.SecondaryPriceLimitType),
				quickfix.GroupElement(tag.SecondaryLowLimitPrice),
				quickfix.GroupElement(tag.SecondaryHighLimitPrice),
				quickfix.GroupElement(tag.SecondaryTradingReferencePrice),
...
func NewNoDerivativeInstrAttribRepeatingGroup() NoDerivativeInstrAttribRepeatingGroup {
	return NoDerivativeInstrAttribRepeatingGroup{
		quickfix.NewRepeatingGroup(
			tag.NoDerivativeInstrAttrib,
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.DerivativeInstrAttribType),
				quickfix.GroupElement(tag.DerivativeInstrAttribValue),
			},
		),
	}
}
