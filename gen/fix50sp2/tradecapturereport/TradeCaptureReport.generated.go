	...
	return NoAllocsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				...
				quickfix.GroupElement(tag.AllocCustomerCapacity),
				quickfix.GroupElement(tag.AllocMethod),
				quickfix.GroupElement(tag.SecondaryIndividualAllocID),
				quickfix.GroupElement(tag.AllocClearingFeeIndicator),
			},
		),
	}
}
...
func NewNoSideTrdRegTSRepeatingGroup() NoSideTrdRegTSRepeatingGroup {
	return NoSideTrdRegTSRepeatingGroup{
		quickfix.NewRepeatingGroup(
			tag.NoSideTrdRegTS,
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.SideTrdRegTimestamp),
				quickfix.GroupElement(tag.SideTrdRegTimestampType),
				quickfix.GroupElement(tag.SideTrdRegTimestampSrc),
			},
		),
	}
}
	...
	return NoSidesRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				...
				quickfix.GroupElement(tag.SideLastQty),
				quickfix.GroupElement(tag.SideTradeReportID),
				quickfix.GroupElement(tag.SideFillStationCd),
				quickfix.GroupElement(tag.SideReasonCd),
				quickfix.GroupElement(tag.RptSeq),
				quickfix.GroupElement(tag.SideTrdSubTyp),
				NewNoSideTrdRegTSRepeatingGroup(),
				quickfix.GroupElement(tag.SideGrossTradeAmt),
				quickfix.GroupElement(tag.AggressorIndicator),
				quickfix.GroupElement(tag.ExchangeSpecialInstructions),
				quickfix.GroupElement(tag.NetGrossInd),
				quickfix.GroupElement(tag.SideCurrency),
				quickfix.GroupElement(tag.SideSettlCurrency),
				NewNoSettlDetailsRepeatingGroup(),
				quickfix.GroupElement(tag.OrderCategory),
				...
				quickfix.GroupElement(tag.RefOrderID),
				quickfix.GroupElement(tag.RefOrderIDSource),
				quickfix.GroupElement(tag.RefOrdIDReason),
				...
				quickfix.GroupElement(tag.SecondaryDisplayQty),
				quickfix.GroupElement(tag.DisplayWhen),
				quickfix.GroupElement(tag.DisplayMethod),
				quickfix.GroupElement(tag.DisplayLowQty),
				quickfix.GroupElement(tag.DisplayHighQty),
				quickfix.GroupElement(tag.DisplayMinIncr),
				quickfix.GroupElement(tag.RefreshQty),
				quickfix.GroupElement(tag.DisplayQty),
				quickfix.GroupElement(tag.OrderCapacity),
				quickfix.GroupElement(tag.OrderRestrictions),
				quickfix.GroupElement(tag.OrigCustOrderCapacity),
				...
				quickfix.GroupElement(tag.SideExecID),
				quickfix.GroupElement(tag.OrderDelay),
				quickfix.GroupElement(tag.OrderDelayUnit),
				quickfix.GroupElement(tag.SideLiquidityInd),
			},
		),
	}
}
...
func NewNoUnderlyingLegSecurityAltIDRepeatingGroup() NoUnderlyingLegSecurityAltIDRepeatingGroup {
	return NoUnderlyingLegSecurityAltIDRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.UnderlyingLegSecurityAltID),
				quickfix.GroupElement(tag.UnderlyingLegSecurityAltIDSource),
			},
		),
	}
}
...
func NewNoOfLegUnderlyingsRepeatingGroup() NoOfLegUnderlyingsRepeatingGroup {
	return NoOfLegUnderlyingsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.UnderlyingLegSymbol),
				quickfix.GroupElement(tag.UnderlyingLegSymbolSfx),
				quickfix.GroupElement(tag.UnderlyingLegSecurityID),
				quickfix.GroupElement(tag.UnderlyingLegSecurityIDSource),
				NewNoUnderlyingLegSecurityAltIDRepeatingGroup(),
				quickfix.GroupElement(tag.UnderlyingLegCFICode),
				quickfix.GroupElement(tag.UnderlyingLegSecurityType),
				quickfix.GroupElement(tag.UnderlyingLegSecuritySubType),
				quickfix.GroupElement(tag.UnderlyingLegMaturityMonthYear),
				quickfix.GroupElement(tag.UnderlyingLegMaturityDate),
				quickfix.GroupElement(tag.UnderlyingLegMaturityTime),
				quickfix.GroupElement(tag.UnderlyingLegStrikePrice),
				quickfix.GroupElement(tag.UnderlyingLegOptAttribute),
				quickfix.GroupElement(tag.UnderlyingLegPutOrCall),
				quickfix.GroupElement(tag.UnderlyingLegSecurityExchange),
				quickfix.GroupElement(tag.UnderlyingLegSecurityDesc),
			},
		),
	}
}
	...
	return NoLegsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				...
				quickfix.GroupElement(tag.LegUnitOfMeasure),
				quickfix.GroupElement(tag.LegTimeUnit),
				quickfix.GroupElement(tag.LegOptionRatio),
				quickfix.GroupElement(tag.LegPrice),
				quickfix.GroupElement(tag.LegMaturityTime),
				quickfix.GroupElement(tag.LegPutOrCall),
				quickfix.GroupElement(tag.LegExerciseStyle),
				quickfix.GroupElement(tag.LegUnitOfMeasureQty),
				quickfix.GroupElement(tag.LegPriceUnitOfMeasure),
				quickfix.GroupElement(tag.LegPriceUnitOfMeasureQty),
				quickfix.GroupElement(tag.LegContractMultiplierUnit),
				quickfix.GroupElement(tag.LegFlowScheduleType),
				...
				quickfix.GroupElement(tag.LegReportID),
				quickfix.GroupElement(tag.LegSettlCurrency),
				quickfix.GroupElement(tag.LegLastForwardPoints),
				quickfix.GroupElement(tag.LegCalculatedCcyLastQty),
				quickfix.GroupElement(tag.LegGrossTradeAmt),
				quickfix.GroupElement(tag.LegNumber),
				NewNoOfLegUnderlyingsRepeatingGroup(),
				quickfix.GroupElement(tag.LegVolatility),
				quickfix.GroupElement(tag.LegDividendYield),
				quickfix.GroupElement(tag.LegCurrencyRatio),
				quickfix.GroupElement(tag.LegExecInst),
				quickfix.GroupElement(tag.LegLastQty),
			},
		),
	}
}
	...
	return NoUnderlyingsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				...
				quickfix.GroupElement(tag.UnderlyingContractMultiplierUnit),
				quickfix.GroupElement(tag.UnderlyingFlowScheduleType),
				quickfix.GroupElement(tag.UnderlyingRestructuringType),
				quickfix.GroupElement(tag.UnderlyingSeniority),
				quickfix.GroupElement(tag.UnderlyingNotionalPercentageOutstanding),
				quickfix.GroupElement(tag.UnderlyingOriginalNotionalPercentageOutstanding),
				quickfix.GroupElement(tag.UnderlyingAttachmentPoint),
				quickfix.GroupElement(tag.UnderlyingDetachmentPoint),
			},
		),
	}
}
	...
	return NoTrdRegTimestampsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				...
				quickfix.GroupElement(tag.DeskType),
				quickfix.GroupElement(tag.DeskTypeSource),
				quickfix.GroupElement(tag.DeskOrderHandlingInst),
			},
		),
	}
}
...
func NewNoTrdRepIndicatorsRepeatingGroup() NoTrdRepIndicatorsRepeatingGroup {
	return NoTrdRepIndicatorsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.TrdRepPartyRole),
				quickfix.GroupElement(tag.TrdRepIndicator),
			},
		),
	}
}
