	...
	return NoLegAllocsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				...
				quickfix.GroupElement(tag.LegAllocSettlCurrency),
	...
	return NoLegsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				...
				quickfix.GroupElement(tag.LegAllocID),
...
func NewNoStrategyParametersRepeatingGroup() NoStrategyParametersRepeatingGroup {
	return NoStrategyParametersRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.StrategyParameterName),
				quickfix.GroupElement(tag.StrategyParameterType),
				quickfix.GroupElement(tag.StrategyParameterValue),
			},
		),
	}
}
...
func NewNoNested4PartySubIDsRepeatingGroup() NoNested4PartySubIDsRepeatingGroup {
	return NoNested4PartySubIDsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.Nested4PartySubID),
				quickfix.GroupElement(tag.Nested4PartySubIDType),
			},
		),
	}
}
...
func NewNoNested4PartyIDsRepeatingGroup() NoNested4PartyIDsRepeatingGroup {
	return NoNested4PartyIDsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.Nested4PartyID),
				quickfix.GroupElement(tag.Nested4PartyIDSource),
				quickfix.GroupElement(tag.Nested4PartyRole),
				NewNoNested4PartySubIDsRepeatingGroup(),
			},
		),
	}
}
...
func NewNoFillsRepeatingGroup() NoFillsRepeatingGroup {
	return NoFillsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			tag.NoFills,
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.FillExecID),
				quickfix.GroupElement(tag.FillPx),
				quickfix.GroupElement(tag.FillQty),
				NewNoNested4PartyIDsRepeatingGroup(),
				quickfix.GroupElement(tag.FillLiquidityInd),
			},
		),
	}
}
...
func NewNoRateSourcesRepeatingGroup() NoRateSourcesRepeatingGroup {
	return NoRateSourcesRepeatingGroup{
		quickfix.NewRepeatingGroup(
			tag.NoRateSources,
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.RateSource),
				quickfix.GroupElement(tag.RateSourceType),
				quickfix.GroupElement(tag.ReferencePage),
			},
		),
	}
}
