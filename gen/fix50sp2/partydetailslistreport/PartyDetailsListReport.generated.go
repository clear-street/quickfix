...
func NewNoPartyAltSubIDsRepeatingGroup() NoPartyAltSubIDsRepeatingGroup {
	return NoPartyAltSubIDsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			tag.NoPartyAltSubIDs,
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.PartyAltSubID),
				quickfix.GroupElement(tag.PartyAltSubIDType),
			},
		),
	}
}
...
func NewNoPartyAltIDsRepeatingGroup() NoPartyAltIDsRepeatingGroup {
	return NoPartyAltIDsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			tag.NoPartyAltIDs,
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.PartyAltID),
				quickfix.GroupElement(tag.PartyAltIDSource),
...
func NewNoContextPartySubIDsRepeatingGroup() NoContextPartySubIDsRepeatingGroup {
	return NoContextPartySubIDsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			tag.NoContextPartySubIDs,
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.ContextPartySubID),
				quickfix.GroupElement(tag.ContextPartySubIDType),
			},
		),
	}
}
...
func NewNoContextPartyIDsRepeatingGroup() NoContextPartyIDsRepeatingGroup {
	return NoContextPartyIDsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			tag.NoContextPartyIDs,
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.ContextPartyID),
				quickfix.GroupElement(tag.ContextPartyIDSource),
				quickfix.GroupElement(tag.ContextPartyRole),
				NewNoContextPartySubIDsRepeatingGroup(),
			},
		),
	}
}
...
func NewNoRiskSecurityAltIDRepeatingGroup() NoRiskSecurityAltIDRepeatingGroup {
	return NoRiskSecurityAltIDRepeatingGroup{
		quickfix.NewRepeatingGroup(
			tag.NoRiskSecurityAltID,
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.RiskSecurityAltID),
				quickfix.GroupElement(tag.RiskSecurityAltIDSource),
			},
		),
	}
}
...
func NewNoRiskInstrumentsRepeatingGroup() NoRiskInstrumentsRepeatingGroup {
	return NoRiskInstrumentsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			tag.NoRiskInstruments,
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.RiskInstrumentOperator),
				quickfix.GroupElement(tag.RiskSymbol),
				quickfix.GroupElement(tag.RiskSymbolSfx),
				quickfix.GroupElement(tag.RiskSecurityID),
				quickfix.GroupElement(tag.RiskSecurityIDSource),
				NewNoRiskSecurityAltIDRepeatingGroup(),
				quickfix.GroupElement(tag.RiskProduct),
				quickfix.GroupElement(tag.RiskProductComplex),
				quickfix.GroupElement(tag.RiskSecurityGroup),
				quickfix.GroupElement(tag.RiskCFICode),
				quickfix.GroupElement(tag.RiskSecurityType),
				quickfix.GroupElement(tag.RiskSecuritySubType),
				quickfix.GroupElement(tag.RiskMaturityMonthYear),
				quickfix.GroupElement(tag.RiskMaturityTime),
				quickfix.GroupElement(tag.RiskRestructuringType),
				quickfix.GroupElement(tag.RiskSeniority),
				quickfix.GroupElement(tag.RiskPutOrCall),
				quickfix.GroupElement(tag.RiskFlexibleIndicator),
				quickfix.GroupElement(tag.RiskCouponRate),
				quickfix.GroupElement(tag.RiskSecurityExchange),
				quickfix.GroupElement(tag.RiskSecurityDesc),
				quickfix.GroupElement(tag.RiskEncodedSecurityDescLen),
				quickfix.GroupElement(tag.RiskEncodedSecurityDesc),
				quickfix.GroupElement(tag.RiskInstrumentSettlType),
	...
	return NoRiskLimitsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				...
				NewNoRiskInstrumentsRepeatingGroup(),
...
func NewNoRelatedPartySubIDsRepeatingGroup() NoRelatedPartySubIDsRepeatingGroup {
	return NoRelatedPartySubIDsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.RelatedPartySubID),
				quickfix.GroupElement(tag.RelatedPartySubIDType),
			},
		),
	}
}
...
func NewNoRelatedPartyAltSubIDsRepeatingGroup() NoRelatedPartyAltSubIDsRepeatingGroup {
	return NoRelatedPartyAltSubIDsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			tag.NoRelatedPartyAltSubIDs,
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.RelatedPartyAltSubID),
				quickfix.GroupElement(tag.RelatedPartyAltSubIDType),
			},
		),
	}
}
...
func NewNoRelatedPartyAltIDsRepeatingGroup() NoRelatedPartyAltIDsRepeatingGroup {
	return NoRelatedPartyAltIDsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			tag.NoRelatedPartyAltIDs,
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.RelatedPartyAltID),
				quickfix.GroupElement(tag.RelatedPartyAltIDSource),
				NewNoRelatedPartyAltSubIDsRepeatingGroup(),
			},
		),
	}
}
...
func NewNoRelatedContextPartySubIDsRepeatingGroup() NoRelatedContextPartySubIDsRepeatingGroup {
	return NoRelatedContextPartySubIDsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			tag.NoRelatedContextPartySubIDs,
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.RelatedContextPartySubID),
				quickfix.GroupElement(tag.RelatedContextPartySubIDType),
			},
		),
	}
}
...
func NewNoRelatedContextPartyIDsRepeatingGroup() NoRelatedContextPartyIDsRepeatingGroup {
	return NoRelatedContextPartyIDsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.RelatedContextPartyID),
				quickfix.GroupElement(tag.RelatedContextPartyIDSource),
				quickfix.GroupElement(tag.RelatedContextPartyRole),
				NewNoRelatedContextPartySubIDsRepeatingGroup(),
			},
		),
	}
}
...
func NewNoRelationshipRiskSecurityAltIDRepeatingGroup() NoRelationshipRiskSecurityAltIDRepeatingGroup {
	return NoRelationshipRiskSecurityAltIDRepeatingGroup{
		quickfix.NewRepeatingGroup(
			tag.NoRelationshipRiskSecurityAltID,
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.RelationshipRiskSecurityAltID),
				quickfix.GroupElement(tag.RelationshipRiskSecurityAltIDSource),
			},
		),
	}
}
...
func NewNoRelationshipRiskInstrumentsRepeatingGroup() NoRelationshipRiskInstrumentsRepeatingGroup {
	return NoRelationshipRiskInstrumentsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.RelationshipRiskInstrumentOperator),
				quickfix.GroupElement(tag.RelationshipRiskSymbol),
				quickfix.GroupElement(tag.RelationshipRiskSymbolSfx),
				quickfix.GroupElement(tag.RelationshipRiskSecurityID),
				quickfix.GroupElement(tag.RelationshipRiskSecurityIDSource),
				NewNoRelationshipRiskSecurityAltIDRepeatingGroup(),
				quickfix.GroupElement(tag.RelationshipRiskProduct),
				quickfix.GroupElement(tag.RelationshipRiskProductComplex),
				quickfix.GroupElement(tag.RelationshipRiskSecurityGroup),
				quickfix.GroupElement(tag.RelationshipRiskCFICode),
				quickfix.GroupElement(tag.RelationshipRiskSecurityType),
				quickfix.GroupElement(tag.RelationshipRiskSecuritySubType),
				quickfix.GroupElement(tag.RelationshipRiskMaturityMonthYear),
				quickfix.GroupElement(tag.RelationshipRiskMaturityTime),
				quickfix.GroupElement(tag.RelationshipRiskRestructuringType),
				quickfix.GroupElement(tag.RelationshipRiskSeniority),
				quickfix.GroupElement(tag.RelationshipRiskPutOrCall),
				quickfix.GroupElement(tag.RelationshipRiskFlexibleIndicator),
				quickfix.GroupElement(tag.RelationshipRiskCouponRate),
				quickfix.GroupElement(tag.RelationshipRiskSecurityExchange),
				quickfix.GroupElement(tag.RelationshipRiskSecurityDesc),
				quickfix.GroupElement(tag.RelationshipRiskEncodedSecurityDescLen),
				quickfix.GroupElement(tag.RelationshipRiskEncodedSecurityDesc),
				quickfix.GroupElement(tag.RelationshipRiskInstrumentSettlType),
				quickfix.GroupElement(tag.RelationshipRiskInstrumentMultiplier),
			},
		),
	}
}
...
func NewNoRelationshipRiskWarningLevelsRepeatingGroup() NoRelationshipRiskWarningLevelsRepeatingGroup {
	return NoRelationshipRiskWarningLevelsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.RelationshipRiskWarningLevelPercent),
				quickfix.GroupElement(tag.RelationshipRiskWarningLevelName),
			},
		),
	}
}
...
func NewNoRelationshipRiskLimitsRepeatingGroup() NoRelationshipRiskLimitsRepeatingGroup {
	return NoRelationshipRiskLimitsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			tag.NoRelationshipRiskLimits,
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.RelationshipRiskLimitType),
				quickfix.GroupElement(tag.RelationshipRiskLimitAmount),
				quickfix.GroupElement(tag.RelationshipRiskLimitCurrency),
				quickfix.GroupElement(tag.RelationshipRiskLimitPlatform),
				NewNoRelationshipRiskInstrumentsRepeatingGroup(),
...
func NewNoRelatedPartyIDsRepeatingGroup() NoRelatedPartyIDsRepeatingGroup {
	return NoRelatedPartyIDsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.RelatedPartyID),
				quickfix.GroupElement(tag.RelatedPartyIDSource),
				quickfix.GroupElement(tag.RelatedPartyRole),
				NewNoRelatedPartySubIDsRepeatingGroup(),
				NewNoRelatedPartyAltIDsRepeatingGroup(),
				NewNoRelatedContextPartyIDsRepeatingGroup(),
	...
	return NoPartyListRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				...
				NewNoPartyAltIDsRepeatingGroup(),
				NewNoContextPartyIDsRepeatingGroup(),
				NewNoRiskLimitsRepeatingGroup(),
				NewNoRelatedPartyIDsRepeatingGroup(),
			},
		),
	}
}
