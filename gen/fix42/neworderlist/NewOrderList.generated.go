	...
	return NoOrdersRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				...
				quickfix.GroupElement(tag.OpenClose),
				quickfix.GroupElement(tag.CoveredOrUncovered),
				quickfix.GroupElement(tag.CustomerOrFirm),
				...
				quickfix.GroupElement(tag.ClearingFirm),
				quickfix.GroupElement(tag.ClearingAccount),
			},
		),
	}
}
